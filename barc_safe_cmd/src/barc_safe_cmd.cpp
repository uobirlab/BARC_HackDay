/*!
Makes sure that robot can be stoped with the stop button in case of an emergency e.g. automatic navigation dangerous commands
 */
...
{
  ros::init(argc, argv, "barc_safe_cmd");
